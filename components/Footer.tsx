        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
            ...
            <div>
              ...
              <div className="rounded-lg overflow-hidden border border-gray-800 shadow-inner mb-6 h-48 w-full">
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3607.123965744108!2d83.00223007522672!3d25.300038777644936!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x398e31e35afd1f8b%3A0xac319e3f661fa8bd!2sPrabir%20Caterer%20%26%20Tent%20House!5e0!3m2!1sen!2sin!4v1769440987047!5m2!1sen!2sin"
                  width="100%"
                  height="100%"
                  style={{ border: 0 }}
              ...
              <ul className="space-y-2 mt-4">
                ...
                <li><Link href="/wedding-caterer-varanasi" className="text-gray-400 hover:text-marigold transition-colors hover:translate-x-1 inline-block">Wedding Catering</Link></li>
                <li><Link href="/tent-house-varanasi" className="text-gray-400 hover:text-marigold transition-colors hover:translate-x-1 inline-block">Tent House & Decor</Link></li>
                <li><Link href="/corporate-catering-varanasi" className="text-gray-400 hover:text-marigold transition-colors hover:translate-x-1 inline-block">Corporate Events</Link></li>
                <li><Link href="/blog" className="text-gray-400 hover:text-marigold transition-colors hover:translate-x-1 inline-block">Blog</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-4">
                <li className="flex items-start">
                  ...
                  <span className="text-gray-400">Gonu Babu Katra,<br />Varanasi, Uttar Pradesh 221001</span>
                </li>
