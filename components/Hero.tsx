    ...
    <div id="home" className="relative h-screen flex items-center justify-center overflow-hidden bg-velvet">
      ...
      <div className="relative z-10 text-center px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto pt-20">
        <div className="animate-slide-up">
          <span className="inline-block py-2 px-6 rounded-full glass-dark text-accent font-bold label-text mb-6 border border-accent/50 shadow-glow">
            EST. 1983 • VARANASI
          </span>

          {/* NEW TYPOGRAPHY SYSTEM */}
          <h1 className="display-heading text-white drop-shadow-[0_4px_8px_rgba(0,0,0,0.9)] mb-4">
            <span className="block text-accent">Rishton ki</span>
            <span className="block">Parampara</span>
          </h1>

          <p className="body-large text-gray-100 max-w-3xl mx-auto drop-shadow-md italic font-serif mt-6">
            "Ghat ki hawa, Shehnai ki goonj, <br />aur <span className="text-accent font-bold">Prabir Da</span> ka bharosa."
          </p>
          ...
          <div className="mt-12 flex flex-col sm:flex-row justify-center gap-6">
            ...
            <a
              ...
              className="px-10 py-4 glass border-2 border-white/80 text-white font-bold rounded-full text-lg hover:bg-white hover:text-velvet transition-all duration-300 flex items-center justify-center group focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-2"
            >
