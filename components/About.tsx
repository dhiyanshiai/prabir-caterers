            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <div className="lg:grid lg:grid-cols-12 lg:gap-16 lg:items-center">
                    ...
                    <div className="col-span-12 lg:col-span-7 order-2 lg:order-1 pt-12 lg:pt-0">
                        ...
                        <p className="body-large text-neutral-700 font-serif">
                            Banaras ki galiyan kahaniyan sunti hain. <strong>1983 se</strong>, Gonu Babu Katra ki chhalak aur <strong>Pandey Haweli</strong> ki shaan humare kaam mein dikhti hai.
                        </p>
                        <p className="body-text text-neutral-600 mt-4">
                            Prabir Da ne shuruwat ek choti si soch se ki thi—"Atithi Devo Bhava". Aaj woh soch Banaras ke hazaron parivaron ka <strong>'Attoot Vishwas'</strong> ban gayi hai.
                        </p>
                        ...
                        <div className="mt-10 flex gap-12 border-t border-gray-200 pt-8">
                            <div>
                                <span className="block text-5xl font-black text-velvet font-serif">40+</span>
                                <span className="text-gray-600 font-medium tracking-wide uppercase text-sm mt-1 block">Saal ka Anubhav</span>
                            </div>
                            <div>
                                <span className="block text-5xl font-black text-velvet font-serif">5k+</span>
            ...
            {showFullStory && (
                <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
                    ...
                    <div className="bg-white w-full max-w-4xl rounded-3xl overflow-hidden relative z-10 animate-slide-up shadow-2xl max-h-[90vh] overflow-y-auto">
                        ...
                        <div className="p-8 sm:p-12 prose prose-lg max-w-none font-serif text-gray-700 leading-relaxed">
