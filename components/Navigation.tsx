      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center">
          ...
          <div className="hidden md:flex items-center space-x-1 lg:space-x-2">
            ...
            >
              Services
              <span className={`absolute bottom-0 left-0 w-full h-0.5 bg-gradient-to-r from-primary to-secondary transform origin-left transition-transform duration-300 ${pathname === '/services-detail' ? 'scale-x-100' : 'scale-x-0 group-hover:scale-x-100'
                }`}></span>
            </Link>
            ...
            >
              Story
              <span className={`absolute bottom-0 left-0 w-full h-0.5 bg-gradient-to-r from-primary to-secondary transform origin-left transition-transform duration-300 ${pathname === '/our-story' ? 'scale-x-100' : 'scale-x-0 group-hover:scale-x-100'
                }`}></span>
            </Link>
            ...
            >
              Gallery
              <span className={`absolute bottom-0 left-0 w-full h-0.5 bg-gradient-to-r from-primary to-secondary transform origin-left transition-transform duration-300 ${pathname === '/gallery' ? 'scale-x-100' : 'scale-x-0 group-hover:scale-x-100'
                }`}></span>
            </Link>
            ...
            >
              Blog
              <span className={`absolute bottom-0 left-0 w-full h-0.5 bg-gradient-to-r from-primary to-secondary transform origin-left transition-transform duration-300 ${pathname && pathname.startsWith('/blog') ? 'scale-x-100' : 'scale-x-0 group-hover:scale-x-100'
                }`}></span>
            </Link>
      ...
      {isOpen && (
        <div className="md:hidden bg-white border-t-4 border-marigold absolute w-full shadow-2xl animate-slide-down">
          <div className="px-4 pt-4 pb-6 space-y-1">
            ...
            {/* Services Section */}
            {/* Services Section */}
            <div className="bg-primary/5 rounded-xl p-2 mx-4 mt-2">
              <div className="text-xs font-bold text-gray-500 px-2 mb-2 uppercase tracking-wider">Our Services</div>

              <Link
                href="/wedding-caterer-varanasi"
                onClick={() => setIsOpen(false)}
                className="flex items-center gap-3 px-2 py-2 rounded-lg hover:bg-white transition-all group"
              >
                ...
                <div className="text-gray-900 font-bold text-sm">Wedding Catering</div>
              </Link>

              <Link
                href="/tent-house-varanasi"
                onClick={() => setIsOpen(false)}
                className="flex items-center gap-3 px-2 py-2 rounded-lg hover:bg-white transition-all group"
              >
                <div className="flex-shrink-0 w-8 h-8 rounded-full bg-white flex items-center justify-center shadow-sm">
                ...
                <div className="text-gray-900 font-bold text-sm">Tent & Decor</div>
              </Link>

              <Link
                href="/corporate-catering-varanasi"
                onClick={() => setIsOpen(false)}
                className="flex items-center gap-3 px-2 py-2 rounded-lg hover:bg-white transition-all group"
              >
                <div className="flex-shrink-0 w-8 h-8 rounded-full bg-white flex items-center justify-center shadow-sm">
                ...
                <div className="text-gray-900 font-bold text-sm">Corporate Events</div>
              </Link>
            </div>
